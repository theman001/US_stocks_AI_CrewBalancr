...
| [whole-integration](whole-integration-codereview.md) | **섹터 간 연결부** 전체 검토 — regime_history 절삭이 regime_call 채점창 침범 · 일기 save 비원자 · state 손상 격리 · #2 D옵션(constraints raise) |
